// api/referral.js
// Endpoints for referral info and tracking.
...
module.exports = async (req, res) => {
     // Apply session middleware - needed for session ID as visitorIdentifier for 'visit'
    sessionMiddleware(req, res, async (sessionErr) => {
        ...
        // --- Handle GET /api/referral?code=... --- (Changed from /info)
        ...
        // --- Handle POST /api/referral --- (Changed from /track)
